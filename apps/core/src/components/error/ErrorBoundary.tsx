        ...
        <div className="min-h-[200px] flex items-center justify-center p-6">
          <div className="max-w-md w-full text-center">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">
              {this.props.language === "mm"
                ? "ကွန်ပိုနန့် အမှားအယွင်း"
                : "Component Error"}
            </h3>
            ...
            <div className="space-y-2">
              ...
              <Button
                ...
                className="w-full"
              >
                <IconComponent name="RefreshCw" className="w-4 h-4 mr-2" /> aa
                {this.props.language === "mm"
                  ? "စာမျက်နှာကို ပြန်ရှင်းသန့်စေပါ"
                  : "Reload Page"}
              </Button>
            </div>
          </div>
    ...
    <ErrorBoundary
      ...
      fallback={(error, errorInfo, retry, language) => (
        <div className="p-4 text-center">
          <IconComponent
            name="Loader"
            className="w-6 h-6 mx-auto mb-2 text-muted-foreground animate-spin"
          />
