        ...
        <div className="pt-8 space-y-4">
          ...
          {customFooterText && (
            <div className="text-center">
              <p className="text-white/80">{customFooterText}</p>
            </div>
          )}
...
//                 className="inline-flex items-center justify-center w-10 h-10 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 hover:border-white transition-all duration-200"
//                 aria-label={
//                   social?.title?.[currentLanguage] ||
//                   social?.title?.en ||
//                   social?.platform ||
//                   "Social link"
//                 }
