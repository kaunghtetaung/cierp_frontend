...
export interface HeaderContainerProps {
  ...
  showLanguageSelector?: boolean;
  showUserMenu?: boolean;
  // When provided, the header skips the CMS-managed menu fetch and
  // renders these items directly. Used by routes outside (cms) — e.g.
  // /library has its own 3-item menu (Library, University Home, About)
  // that's unrelated to the tenant's CMS-authored navigation.
  navigationItems?: NavigationItem[];
}
