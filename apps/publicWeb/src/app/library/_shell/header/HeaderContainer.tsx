...
export async function HeaderContainer({
  ...
  try {
    ...
    // Critical fetches failed — redirect to the friendly
    // service-unavailable page instead of rendering a broken
    // half-header fragment. Matches the page-level error UX.
